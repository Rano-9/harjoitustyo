...
class TestParser(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.depth = 3
        self.markov = Markov(self.depth,self.file)
        self.kirjasto = {
            "c": 60,
            "d": 62,
            "e": 64,
    ...
    def test_markov_ketju_tuottaa_satunnaista_mutta_datassa_olevia_nuotteja(self):
        ...
        self.assertFalse([60,69] in self.markov.puu)
        self.assertFalse([65,65,60] in self.markov.puu)
        
        # Ja sata varmasti on datassa
        
        self.assertTrue([65,65,62] in self.markov.puu)